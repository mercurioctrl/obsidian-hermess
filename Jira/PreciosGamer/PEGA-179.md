...
Identificador único (PK autoincremental)

`itemId`

VARCHAR(255)

ID del producto sobre el cual se reporta feedback

`type`

VARCHAR(50)

Tipo de feedback (por ahora solo `"shipping"`)

`value`

BOOLEAN

Valor del feedback (`true` o `false`)

`ip`

VARCHAR(45)

Dirección IP del usuario que envió el feedback

`created_at`

TIMESTAMP

Fecha y hora en la que se registró el feedback
