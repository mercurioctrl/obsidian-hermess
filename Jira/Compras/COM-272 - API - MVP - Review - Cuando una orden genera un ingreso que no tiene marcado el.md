...
- **action item from:** [[COM-190 - API -MVP - Refactor - Elegir si altera o no el costo promedio del item para|COM-190]] API -MVP - Refactor - Elegir si altera o no el costo promedio del item para cada item
