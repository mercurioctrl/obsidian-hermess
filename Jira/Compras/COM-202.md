...
Depósito de destino (almacén donde ingresa el stock)
...
Cantidad ingresada (valor positivo, por ejemplo `10`)

`sAnterior`

Stock en el depósito antes del movimiento

`sPosterior`

Stock en el depósito después del movimiento

`agente`

Usuario o proceso que ejecuta el movimiento
