...
- **action item from:** [[INV-321 - API - Refactor - Recurso ZPL para imprimir qr de certificacion - Multiplicador|INV-321]] API - Refactor - Recurso ZPL para imprimir qr de certificacion -> Multiplicador de cantidad
