...
| AC | Criterio |
| --- | --- |
| AC1 | Ranking suma compras de todos los clientes del user. |
| AC2 | Snippet no expone ranking completo ni parámetros de paginación. |
| AC3 | Admin ranking devuelve listado completo paginado. |
