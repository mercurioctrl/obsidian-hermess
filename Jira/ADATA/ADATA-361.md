...
Import soporta preview + mapping antes de insertar.

AC2

Filas inválidas se rechazan con motivo por fila.

AC3

Si el archivo trae CUIT por fila, se resuelve clientId por CUIT y se valida pertenencia al user.

AC4

Se devuelve resumen final (ok/rechazadas/warnings).
