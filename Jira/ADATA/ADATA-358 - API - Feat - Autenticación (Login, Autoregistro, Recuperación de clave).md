...
| AC | Criterio |
| --- | --- |
| AC1 | Register crea usuario y permite login. |
| AC2 | Login retorna sesión/token y permite acceder a /me. |
| AC3 | Forgot/reset password funciona con token de un solo uso y expiración. |
| AC4 | Errores son explícitos (credenciales inválidas, token vencido, etc.). |
