...
Devuelve todos sin filtro

`companyCode=11`

Solo los que tienen `companyCode = 11`

`companyCode=11&includeNull=true`

Los de `companyCode = 11` más los que tienen `companyCode IS NULL`
