...
- **action item from:** [[LAW-59 - API - EXP - Refactor - Evitar autorizacion para finalizar armado si posee el|LAW-59]] API - EXP - Refactor - Evitar autorizacion para finalizar armado si posee el permiso expUnlockHand
