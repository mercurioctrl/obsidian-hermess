...
Tipo de percepción: `"arba"` o `"agip"`

`between`

string

Rango de fechas en formato `DD-MM-YYYY_DD-MM-YYYY`

`currentPage`

int

Página actual para la vista en JSON
...
Si es `1`, genera archivo `.txt`. Si es `0`, devuelve JSON paginado
