...
`bundleUtilityPL` +`bundleUtilityPL1`

`PORC_GANAN_ESTIP` (eso es segun el caculo de google doc [link](https://docs.google.com/spreadsheets/d/1ntdPbs-wnLG6oqs20DmmByzE7ND8Twuq2P7-EBv30-c/edit?usp=sharing), osea: utilidad=ganancia/costo ) 

`bundleUtilityMAY1` + `bundleUtilityMAY2`

`PORC_GANAN_ESTIP3` (eso es segun el caculo de google doc [link](https://docs.google.com/spreadsheets/d/1ntdPbs-wnLG6oqs20DmmByzE7ND8Twuq2P7-EBv30-c/edit?usp=sharing) , osea: utilidad=ganancia/costo)

`bundleUtilityLO` + `bundleUtilityLO1`

`PORC_GANAN_ESTIPLO` (eso es segun el caculo de google doc [link](https://docs.google.com/spreadsheets/d/1ntdPbs-wnLG6oqs20DmmByzE7ND8Twuq2P7-EBv30-c/edit?usp=sharing), osea: utilidad=ganancia/costo )
