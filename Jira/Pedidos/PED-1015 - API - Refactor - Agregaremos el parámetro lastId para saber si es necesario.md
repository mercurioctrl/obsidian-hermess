...
- **blocks:** [[PED-1016 - APP - Refactor - Agregaremos el parámetro lastId para saber si es necesario|PED-1016]] APP - Refactor - Agregaremos el parámetro lastId para saber si es necesario recargar el chat
