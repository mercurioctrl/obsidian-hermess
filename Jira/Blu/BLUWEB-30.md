...
✅ Eliminación exitosa, con contenido

El usuario fue eliminado y se devuelve un mensaje o el objeto eliminado en el cuerpo.
...
Por ejemplo, si el ID no es válido (ej. una cadena en lugar de número).

**401 Unauthorized**

❌ No autenticado

No se envió token de autenticación o es inválido.
...
No existe un usuario con ID = 3.

**500 Internal Server Error**

❌ Error interno

Fallo inesperado del servidor al procesar la eliminación.
