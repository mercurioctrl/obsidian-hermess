...
- **blocks:** [[NBWEB-737 - APP - Refactor Al procesar el carrito y recibir el error debe ser posible|NBWEB-737]] APP - Refactor: Al procesar el carrito y recibir el error debe ser posible mostrar el mensaje con el nuevo objeto entregado por la api
