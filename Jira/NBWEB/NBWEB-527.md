...
Margen autorización remito

`truckLimit`

Límite de seguro de envío: Es el máximo de costo de mercadería asegurado para transporte camioneta.

`varCurrency`

Variación de cotización: Es la variación que se puede hacer al cambiar la cotización, sin que me muestre un alerta (evita que nos equivoquemos al setear la cotización del día)

`checksDays`

Días máximos para cheques: Es la cantidad máxima de días que puede tener un cheque

`maxCurrencyUser`

Cotización máxima: Es la variación máxima entre cotización del día y cotización liquidada

`annualRate`

Tasa de interés anual: Es la tasa de interés anual general

`perceptionAndRetention`

Percepcion/Retencion: Indica si se cobran y pagan retenciones/percepciones
