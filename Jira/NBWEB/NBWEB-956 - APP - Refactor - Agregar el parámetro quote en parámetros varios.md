...
- **action item from:** [[NBWEB-954 - API - Refactor - Agregar el parámetro quote a parametros varios|NBWEB-954]] API - Refactor - Agregar el parámetro quote a parametros varios
