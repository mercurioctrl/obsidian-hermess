...
Monto a retirar (Debe ser menor o igual al saldo disponible).
...
ID de la cuenta bancaria asociada del usuario.
...
Ya existe un retiro pendiente para este usuario.

`500 Internal Server Error`

Error inesperado al registrar la solicitud.
