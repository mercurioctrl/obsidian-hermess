...
- **action item from:** [[LIO-575 - API - Fet - Agregar campo description (título) al PATCH de productos del|LIO-575]] API - Fet - Agregar campo description (título) al PATCH de productos del inventario
