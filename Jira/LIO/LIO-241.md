...
Se debe proporcionar `bankAlias` o `bankCBU`.

`409 Conflict`

Ya existe una cuenta bancaria para el cliente.
...
No se encontró la cuenta bancaria para el cliente.
...
No se encontró la cuenta bancaria para eliminar.

`409 Not Found`

Existen movimiento pendientes relacionados a la cuenta, una vez terminado el proceso vuelva  intentarlo.
