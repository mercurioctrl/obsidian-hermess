...
Array de marcas — respuesta directa del servicio downstream

401 Unauthorized

Token JWT no presente o inválido

4xx / 5xx

Error del servicio downstream, se propaga con el mismo status code
