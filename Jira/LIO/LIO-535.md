...
Flag de operación drop shipping
...
El endpoint v4 devuelve resultados equivalentes al endpoint legacy

AC2

Los filtros soportados actualmente funcionan correctamente

AC3

Los filtros no implementados quedan documentados como deprecated

AC4

No quedan dependencias activas del endpoint legacy

AC5

El endpoint queda documentado para consumidores
