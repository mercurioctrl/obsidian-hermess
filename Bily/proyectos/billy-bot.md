# Billy Bot (Bot WhatsApp - Microservicios)

*Proyecto interno / Nombre clave: Billy Bot*
...
6. **Visión / Facturas (vision-service)**
   ...
   - Objetivo: análisis de imágenes, leer y entender fotos de facturas, tickets, remitos, presupuestos, etc.
   - **Capacidad clave:** OCR (Reconocimiento Óptico de Caracteres). No solo debe entender el contenido visual, sino extraer explícitamente el texto.
   - Endpoints previstos:
