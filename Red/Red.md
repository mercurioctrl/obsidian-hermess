...
- [[08-home-assistant#Rutinas / iluminación automática]] — Dashboard "Casa" + rutinas de iluminación exterior (atardecer→amanecer calle/terraza, jardín WiZ→medianoche), lectura de nombres por gang desde la app (`shadow/properties`) y regla dura de la cámara del jardín (switch siempre ON) (agosto 2025)
