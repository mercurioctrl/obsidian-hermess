---
tags: [finanzas, tarjeta, dashboard, gastos]
---
...
```mermaid
xychart-beta
    title "Consumos mensuales — Visa+Amex (millones ARS)"
    x-axis [Ene, Feb, Mar, Abr, May, Jun, Jul, Ago]
    y-axis "M ARS" 0 --> 15
    bar [12.26, 7.6, 7.35, 9.05, 11.6, 13.85, 13.92, 8.93]
    line [12.26, 7.6, 7.35, 9.05, 11.6, 13.85, 13.92, 8.93]
```
...
```mermaid
xychart-beta
    title "Transporte/Autos — M ARS/mes"
    x-axis [Ene, Feb, Mar, Abr, May, Jun, Jul, Ago]
    y-axis "M ARS" 0 --> 2
    bar [1.18, 0.89, 0.82, 0.73, 0.99, 0.76, 0.88, 0.78]
    line [1.18, 0.89, 0.82, 0.73, 0.99, 0.76, 0.88, 0.78]
```

### Salud
```mermaid
xychart-beta
    title "Salud — M ARS/mes"
    x-axis [Ene, Feb, Mar, Abr, May, Jun, Jul, Ago]
    y-axis "M ARS" 0 --> 2
    bar [0.74, 0.76, 0.78, 1.0, 0.95, 0.79, 1.29, 0.02]
    line [0.74, 0.76, 0.78, 1.0, 0.95, 0.79, 1.29, 0.02]
```
