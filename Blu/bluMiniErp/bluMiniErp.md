...
**Ultima sincronizacion:** 2026-09-03
...
| [[Modulo Requerimientos]] | **Tablero tipo Trello por cliente** en el mismo portal que Novedades (tabs, mismo `novedades_token`). El cliente carga/mueve tarjetas (Trello completo); el equipo gestiona columnas y **convierte un requerimiento en Tarea** interna. Notifica a admins (in-app + push). Seguimiento/intake, no toca finanzas. Mig 0111. `VER_SECCION_REQUERIMIENTOS` (rama `feat/requerimientos-cliente`, PR #56, 2026-09-03) |
