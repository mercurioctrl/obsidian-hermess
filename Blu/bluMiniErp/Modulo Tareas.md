...
- **NotificacionService** notifica a los seguidores (menos al actor): in-app (`notificaciones`) + push, correo (`TareaCambioMail`, **por el mailer `erp@`** desde 2026-08-25), WhatsApp.
