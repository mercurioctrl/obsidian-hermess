...
2026-06-25 — **Ajuste de precios de la propuesta de negocios Gigabyte** (`gigabyte-negocios`): Marketing pasa de **USD 1.000 → 1.500/mes** y los tres abonos de Ads bajan USD 500 c/u (Básico **1.250**, Regular **2.000**, Premium **2.700**). Se documentó el **gotcha de precios duplicados** en `NegociosPresentation.vue` — cada precio vive en 2–3 lugares (array `adsPlans` + tabla comparativa + pilares del cierre) y hay que tocarlos todos. Ver [[changelog#2026-06-25 — Ajuste de precios propuesta de negocios Gigabyte|changelog 2026-06-25]] y [[memoria#Gotcha: precios duplicados en NegociosPresentation.vue|memoria]].
