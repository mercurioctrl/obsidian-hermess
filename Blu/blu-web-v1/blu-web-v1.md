...
2026-05-08 — Sesión larga sobre la propuesta Gigabyte (`/propuestas/gigabyte?token=gbt-mkt-2026`): copy reescrito, identidad cromática por sección (azul/naranja/rosa según contexto), confetti CTA en el closer, sub-marcas re-encuadradas (AERO con logoMaxHeight, AORUS Mark con buchino.png, slot fijo de 36px para alinear tags), removido grid de tiles de "Verticales" pero conservado el header, fixes mobile (tachado de "No se improvisa" con line-through cuando wrappea, chip nav "Propuesta · Mayo 2026" → solo "Propuesta" en ≤900px), marquesina 38s→14s, todos los assets de marca Gigabyte versionados (111 archivos en `assets/html/gigabyteBrand/`). Ver [[changelog#2026-05-08 — Continuación polish Gigabyte commits del día|changelog 2026-05-08]] y previo [[changelog#2026-05-07 — Polish visual de la propuesta Gigabyte|2026-05-07]].
