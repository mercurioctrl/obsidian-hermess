...
- [[arquitectura]] — Contexto en el monorepo, páginas, layouts, i18n, auth, [[arquitectura#Catálogo de merch|catálogo de merch]]
...
- [[arquitectura#Catálogo de merch|Catálogo de merch]] en `/catalogo-merch` — galería de productos importada desde CSV (ver [[changelog#2026-04-13 — Catálogo de merch|changelog 2026-04-13]])
- [[base-de-conocimiento#Admin Panel cmsadmin|Panel admin]] en `/cmsadmin` — contactos, citas, horarios, catálogo, usuarios

## Última sincronización

2026-04-13 — sincronización con catálogo de merch completo (backend + front + admin)
