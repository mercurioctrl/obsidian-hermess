...
Queremos proponerte formalizar tu incorporación al equipo **en relación de dependencia**, con todos los beneficios que eso implica. Te dejamos por escrito cómo quedaría, así lo revisás con tranquilidad y, si te parece bien, avanzamos. La decisión es tuya.

## 1. Tu sueldo

- **Cobrarías el mismo neto que hoy: $1.450.000 por mes.** Tu ingreso de bolsillo no cambiaría.
- En el recibo verías un **sueldo bruto** más alto, del cual se descuentan tus aportes (jubilación, obra social, etc.). Eso es normal y esperable: esos aportes **trabajan para vos** (se explica en el punto 4). Lo que te queda sigue siendo $1.450.000.
- **Aguinaldo (SAC):** además de tu sueldo, cobrarías **dos medios aguinaldos al año** (en junio y en diciembre). Es dinero adicional.
...
- Vacaciones pagas según antigüedad (arrancan en 14 días y van subiendo).
- Licencias (enfermedad, estudio, familiares, etc.).
- Antigüedad y todos los derechos de la Ley de Contrato de Trabajo.
...
- **Antigüedad** y estabilidad: todos los derechos laborales de la ley.
- Recibo de sueldo formal, que te sirve para **créditos, alquileres, trámites**, etc.
