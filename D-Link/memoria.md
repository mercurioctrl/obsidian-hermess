...
- **Editor + versiones de newsletters (sep-2026):** `editor-newsletters.html` + `servidor.py` (API que guarda
  versiones en disco `versiones/`, **compartidas** por todo el equipo vía `http://<IP>:8000`). Juego de 4
  templates: **M15, M30, DCS-6501LH** (B2C) + **DAP-X3060** (Access Point, B2B). Ver [[newsletter-campana#10. Set de templates + editor web (2026-09-11)|newsletter-campana]].
