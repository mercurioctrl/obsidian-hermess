...
issuetype: Epic
project: ADATA
updated: "2026-02-19T11:52:03.987-0300"
created: "2026-02-19T11:11:00.636-0300"
url: "https://bluinc.atlassian.net/browse/ADATA-356"
tags: [jira, ADATA, por-hacer]
---

# ADATA-356 · XPG - Landing Fidelización (Puntos + Aceleradores + Ranking + Carga Compras)

[ADATA-356 en Jira](https://bluinc.atlassian.net/browse/ADATA-356)
...
- Carga de compras:  - Manual
  - Importación Excel con **mapeo de columnas** + preview + validación
- Aceleradores:  - Vigentes / Próximos / Expirados
  - Match por SKU exacto o por match parcial (contiene)
- Ranking:  - Usuario ve solo: **posición propia + anterior + siguiente** (no ranking completo)
  - Admin ve ranking completo
- Panel Admin:  - ranking completo
...
- Vigencia por fecha:  - si existe `fechaCompra` usar esa para validar vigencia
...
- **Frontend XPG**: implementación de pantallas según mockups:  - login + recuperación
  - registro
...
Mokup: https://blu.inc/programaXpg/

Repositorio: [git@github.com](mailto:git@github.com):BluIncStudio/programaXpg.git

---
_Sincronizado por jira-sidecar el 2026-06-07 22:31:51 UTC._
