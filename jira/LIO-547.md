...
issuetype: Subtarea
project: LIO
updated: "2026-02-23T16:42:02.285-0300"
created: "2026-02-23T07:47:40.907-0300"
url: "https://bluinc.atlassian.net/browse/LIO-547"
tags: [jira, LIO, selected-for-development]
---

# LIO-547 · API - Feat - Migrar historial de productos visitados (home)

[LIO-547 en Jira](https://bluinc.atlassian.net/browse/LIO-547)
...
1. Se identifica al usuario a través del token de autenticación.
2. Se consulta la tabla de visitas (productosVisitas) para obtener los últimos productos que el usuario navegó, eliminando  
duplicados por producto_id y ordenando del más reciente al más antiguo.
3. Si el usuario tiene menos de 5 visitas registradas, se retorna un array vacío (no se muestra la sección).
4. Con los IDs de los productos visitados, se consulta el detalle completo de cada uno incluyendo precios, estados, envíos, cuotas,  
marca y vendedor.
5. Importante: la query de detalle utiliza mostrarOcultos = true, lo que significa que no filtra por stock ni por activo — solo  
