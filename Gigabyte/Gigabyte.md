...
### gigaErp
Sistema interno de gestión de distribuidores, marketing, mercadería, catálogo, órdenes de venta y tareas.
- [[gigaErp/gigaErp|gigaErp — Sistema de gestión]] — \`http://10.10.10.7:8824\`
  - [[gigaErp/arquitectura|Arquitectura]] — stack, modelos, Productos/Existencias/Órdenes, stock dinámico por depósito
