...
- **Arquitectura**: un solo `index.html` autocontenido (~776 KB, fuentes woff2 + imágenes en base64), sistema de slides + componentes AORUS + capa de herramientas (editor / presentación / edición de textos / export). Ver [[arquitectura]].
