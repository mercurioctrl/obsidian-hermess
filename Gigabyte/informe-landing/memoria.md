...
- **Entregable aparte — Landing ejemplo de anuncios** (`landing-ejemplo-ads/campana-q2-familia-giga40.html`): le muestra al cliente cómo se ven los anuncios reales de la campaña **Familia GIGA40** en mockups realistas de Meta + Google, personalizados por reseller (selector). Tiene una **sección de estrategia** (captura vs generación, funnel, benchmarks AR, medición/geo-lift, calendario por país) con fuentes accesibles. Detrás de un **gate de acceso** (token client-side, solo hash SHA-256 en el archivo). Ver [[landing-ejemplo-ads]] y el dossier [[research-paid-media]].
