...
### Stock de productos
- Campo `stock` directo en tabla `productos` (no por depósito en este módulo)
- El módulo de stock legacy (`stock_deposito`) sigue existiendo pero no lo usa el módulo Productos
- 5% de probabilidad de stock = 0 al seed; resto entre 1 y 150 unidades
