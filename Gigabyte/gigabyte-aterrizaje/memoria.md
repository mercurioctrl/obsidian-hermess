...
- Stack Nuxt 3 SSR + Tailwind (PostCSS nativo). Datos de [[api-partpicker|BluPartPicker]] vía `server/api/*` (oculta la key en `.env`).
...
- [[gigabyte-aterrizaje]] · [[contexto]] · [[arquitectura]]
