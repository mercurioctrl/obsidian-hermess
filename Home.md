...
- [[Blu/rrhh/rrhh|índice]] · [[Blu/rrhh/contexto|contexto]] · [[Blu/rrhh/agenda-primera-reunion|agenda primera reunión]] · [[Blu/rrhh/actividades-rrhh-it|actividades RRHH IT]]
...
- [[Asus/Asus|Asus]]
  - `Contrataciones/` · `saMiniSiteCodes/`

## Catirel

- [[Catirel/Catirel|Catirel]]
  - `Modelos de archivo/` · `Proyectos/`
...
- [[Libre Opcion/Libre Opcion|Libre Opción]]
  ...
  - `TareaWallet/` · `blu-report/` · `enviosMailDrop/` · `tareas/`

## NB

- [[NB/NB|NB]]
  - `Compras/` · `Comprobantes/` · `controldeprecios/` · `expedicion/`
  - `inventario/` · `microservicio-envios/` · `pedidos/` · `sincroAfip/`

## Planilla Acciones Bully

- [[Planilla Acciones Bully/Planilla Acciones Bully|Planilla Acciones Bully]]
  - [[Planilla Acciones Bully/arquitectura|arquitectura]] · [[Planilla Acciones Bully/bully|bully]] · [[Planilla Acciones Bully/Documentacion Apps Script - Opciones API|Docs API]] · `codigo/`
